...
public class Move {
  ...
  public static final Move[] movs = new Move[]{
      new Move(Move.RIGHT, Move.NONE, Move.NONE),
      new Move(Move.LEFT, Move.NONE, Move.NONE),
      new Move(Move.NONE, Move.NONE, Move.UP),
      new Move(Move.NONE, Move.NONE, Move.DOWN)
  };
